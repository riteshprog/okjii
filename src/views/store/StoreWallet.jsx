                ...
                <div class="col-lg-12">
                  <div class="row justify-content-center">
                   ...
                   <div class="col-lg-5 col-md-6 col-sm-6">
                    <a class="wallet-link" href="viewPreviousTransacations.html">
                        ...
                        <div class="wallet-card-body ">
                          <div class="row">
                            <div class="wallet-text row">
                                ...
                                <div class="numbers">
                                  <p class="card-category">View Previous Settlement
                                </p>
                              </div>
                            </div>
                   ...
                   <div class="col-lg-5 col-md-6 col-sm-6">
                    <a class="wallet-link" href="storeDownloadStatement.html">
                      <div class="wallet-card wallet-card-stats">
                        <div class="wallet-card-body ">
                          <div class="row">
                            <div class="wallet-text row">
