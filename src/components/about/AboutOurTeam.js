    ...
    return (
        <div className="container-fluid our-team">
          ...
          <figure className="text-center">
            <img src={Mannu} alt="" className="img-fluid rounded-circle Mannu" />
            <figcaption>
              <h2>Mannu Jha <i class="fab fa-linkedin"></i></h2>
        ...
        <div className="row pt-5">
          ...
          <figure className="text-center">
            ...
            <figcaption>
              <h2>Vicky Aggarwal <i class="fab fa-linkedin"></i></h2>
              <p>Technical Head</p>
            </figcaption>
          </figure>
          ...
          <div className="col-md-3 col-sm-6">
          <figure className="text-center">
            <img src={Depti} alt="" className="img-fluid rounded-circle Vicky" />
            <figcaption>
              <h2>Deepti Anand  <i class="fab fa-linkedin"></i></h2>
          ...
          <div className="col-md-3 col-sm-6">
          <figure className="text-center">
            <img src={Akash} alt="" className="img-fluid rounded-circle Vicky" />
            <figcaption>
              <h2>Akash Khatr <i class="fab fa-linkedin"></i></h2>
          ...
          <div className="col-md-3 col-sm-6">
          <figure className="text-center">
            <img src={Ravi} alt="" className="img-fluid rounded-circle Vicky" />
            <figcaption>
              <h2>Ravi Kumar <i class="fab fa-linkedin"></i></h2>
        ...
        <div className="col-md-3 col-sm-6">
          <figure className="text-center">
            ...
            <figcaption>
              <h2>Ritesh Kumar <i class="fab fa-linkedin"></i></h2>
              <p>React Developer</p>
            </figcaption>
          </figure>
          ...
          <div className="col-md-3 col-sm-6">
          <figure className="text-center">
            <img src={Sweety} alt="" className="img-fluid rounded-circle Vicky" />
            <figcaption>
              <h2>Sweety  <i class="fab fa-linkedin"></i></h2>
          ...
          <div className="col-md-3 col-sm-6">
          <figure className="text-center">
            <img src={Aastha} alt="" className="img-fluid rounded-circle Vicky" />
            <figcaption>
              <h2>Aastha Thakur <i class="fab fa-linkedin"></i></h2>
              <p>Inventory Head</p>
            </figcaption>
          </figure>
          ...
          <div className="col-md-3 col-sm-6">
          <figure className="text-center">
            <img src={Simpy} alt="" className="img-fluid rounded-circle Vicky" />
            <figcaption>
              <h2>Simpy Kashyap <i class="fab fa-linkedin"></i></h2>
