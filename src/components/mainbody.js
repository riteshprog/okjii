...
<img src={Asset6} className="img-fluid"  alt="" />
                  ...
                  <div className="col-md-12 col-sm-12 col-lg-5 width-35 order-md-1 mt-5 okjii-explore okjii-explore-left">
                    ...
                    <p>A revolutionnnnn in grocery shopping where a customer can buy from their old reliable “Kirana” store without physically going there. A digital hub of all local, neighbourhood retail shop with era driven look and mechanism.
