...
export default class ContactBestWay extends Component {
  render() {
    return (
      <div className="container okjii-contactus df fdc">
        <h1>
          <b className="sell">Best way to Connectss</b> with OkkJI
        </h1>
        <div className="row okjii-whatsapp">
          <div className="col-sm-12 col-md-4">
            <MDBCard className="card-body  faq-card">
              <MDBCardText>
                <img src={whatsapp} alt="" width="15%" height="15%" /> Whatsapp
              </MDBCardText>
            </MDBCard>
          </div>
          <div className="col-sm-12 col-md-4">
            <MDBCard className="card-body  faq-card">
              <MDBCardText>
                <img src={call} alt="" width="11%" height="8%" /> 1800 1212 2121
              </MDBCardText>
            </MDBCard>
          </div>
          ...
          <div className="col-sm-12 col-md-4">
            <MDBCard className="card-body  faq-card">
              <MDBCardText>
                <img src={chat} alt="" width="17%" height="15%" /> Live Chat
              </MDBCardText>
            </MDBCard>
          </div>
        </div>
        <div className="row card-address">
          <div className="col-sm-12 col-md-4">
            <figure>
              ...
              <h3>ADDRESS </h3>
              <p>
                MM Tower, Udyog Vihar,
                <br />
                Phase IV , Gurugram, 122004
              </p>
            </figure>
          </div>
          <div className="col-sm-12 col-md-4">
